-- Fix create_billing_checkout: billing_checkouts.id is bigint, not uuid.
-- Asaas payment/subscription ids are numeric strings (e.g. "6"), which broke
-- `returning id into checkout_id` when checkout_id was declared as uuid.
